...
const PricingSection: React.FC = () => {
  ...
  const pricingPlans: PricingCardProps[] = [
    ...
    },
    {
      ...
      features: ['ابزارهای نوشتاری پیشرفته', 'تولید محتوای نامحدود', 'پشتیبانی ویژه'], // Advanced writing tools, Unlimited content generation, Priority support
      isPopular: true,
  ...
  return (
    <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-lg">
      <h2 className="mb-6 text-2xl font-semibold text-slate-800">قیمت‌گذاری</h2> {/* Pricing */}
